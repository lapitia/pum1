...
// litery na cyfry telefonu
    ...
    return word
        .lowercase() // zamieniamy litery na małe w słowie
        .map { phoneMap[it] ?: "" } // każdą literę zamieniamy na cyfry
        .joinToString("") // łączymy w jeden string
}

fun main(){
println(convert("franek")) // 3337772663355
}